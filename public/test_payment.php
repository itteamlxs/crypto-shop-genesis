...
// Default product ID if not provided
$productId = filter_input(INPUT_GET, 'product_id', FILTER_VALIDATE_INT) ?: 1;
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mb-3">
                            <div class="qr-code bg-light p-3 d-inline-block">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo urlencode('bitcoin:' . $paymentData['address'] . '?amount=' . $paymentData['amount_btc']); ?>" 
                        ...
                        <div class="alert alert-warning">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($paymentData['address']); ?>" readonly>
                                <button class="btn btn-outline-secondary" type="button" onclick="copyToClipboard('<?php echo htmlspecialchars($paymentData['address']); ?>')">Copy</button>
                            </div>
                            <p class="mb-0"><strong>Amount:</strong> <?php echo $paymentData['amount_btc']; ?> BTC</p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <button id="check-status" class="btn btn-primary" data-order-id="<?php echo $orderId; ?>">Check Payment Status</button>
